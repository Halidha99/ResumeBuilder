...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600;700&family=Abhaya+Libre:wght@800&display=swap"
        rel="stylesheet">
...
<section class="templates" id="templates">
    ...
    <section class="about" id="about">
        ...
        <div class="about-content">
            ...
            <p>We created this platform to help you quickly design a professional resume without the hassle of
                complicated formatting or design.</p>
            <p>Whether you’re starting your career or looking to make a change, ResumeXpert provides simple, modern, and
                customizable templates that make your resume stand out. Plus, it’s free to get started—no hidden fees,
                no surprises.</p>
        </div>
    </section>
    ...
    <script>
        ...
        // Auto-slide (fixed typo from set-interval to setInterval)
